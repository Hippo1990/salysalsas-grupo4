        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src={imagen1} alt="Los Angeles" width="2000px" height="200"></img>
                    ...
                    <div class="carousel-item">
                        <img src={imagen1} alt="Chicago" width="2000px" height="200"></img>
                        <div class="carousel-caption">
                            <div class="row">
                                <div class="col-3">
                        ...
                        <div class="carousel-item">
                            <img src={imagen1} alt="New York" width="2000px" height="200"></img>
                            <div class="carousel-caption">
                                <div class="row">
                                    <div class="col-3">
...
export default Asideinformacion;